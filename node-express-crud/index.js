...
const app = express();//crea el servidor express
...
app.post("/books", (req, res) => {
    const data = readData();
    const body = req.body;// es lo que hay dentro de los {} en las peticiones
...
//Funció per escoltar
app.listen(3000, () => {
    console.log("Server listing on port 3000");//lo pone en marcha
});